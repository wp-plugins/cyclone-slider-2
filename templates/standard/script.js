(function() {
	jQuery(document).on('cycle-before', '.cycloneslider-template-standard .cycloneslider-slides', function( event, optionHash, outgoingSlideEl, incomingSlideEl, forwardFlag ) {
    ...
    jQuery(document).on('cycle-initialized cycle-after', '.cycloneslider-template-standard .cycloneslider-slides', function( event, optionHash, outgoingSlideEl, incomingSlideEl, forwardFlag ) {
